...
const GlassButton = React.forwardRef(
  (
    { className, children, size, contentClassName, glassColor, ...props },
    ref,
  ) => {
    ...
    return (
      <>
        ...
        >
          ...
          <span
            className={cn(
              "btn-liquid-text relative z-10 w-full flex items-center justify-center gap-[inherit] select-none",
              contentClassName,
            )}
          >
            {children}
