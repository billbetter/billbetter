...
export const ENTITY_COLUMNS = {
  "BusinessSettings": ["id", "user_id", "business_name", "email", "phone", "address", "website", "timezone", "tax_rate", "hourly_rate", "invoice_prefix", "payment_terms", "pdf_color_scheme", "pdf_footer_text", "show_pdf_branding", "font_family", "invoice_template", "stripe_account_status", "stripe_onboarding_completed", "google_calendar_connected", "booking_enabled", "default_appointment_duration", "booking_buffer_time", "booking_notice_time", "send_review_requests", "analytics_email_frequency", "analytics_email_day", "analytics_email_time", "created_at", "updated_at", "stripe_account_id", "currency", "google_calendar_id", "pdf_background_color", "pdf_text_color", "pdf_muted_text_color", "logo_url", "serpapi_key", "review_link", "email_subject_template", "email_body_template", "custom_template_config"],
  ...
  "Invoice": ["id", "user_id", "invoice_number", "client_id", "client_name", "client_email", "client_phone", "client_address", "items", "subtotal", "tax_rate", "tax_amount", "total", "status", "due_date", "paid_date", "notes", "delivery_method", "payment_link", "pdf_url", "created_at", "updated_at", "stripe_payment_intent_id", "stripe_session_id", "platform_fee_amount", "payment_terms", "pdf_generated_at", "public_token", "public_link_revoked_at", "first_viewed_at", "last_viewed_at", "view_count", "platform_fee_percent"],
